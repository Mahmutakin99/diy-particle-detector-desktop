...
parser = argparse.ArgumentParser(description="Plot iPadPix recordings")
parser.add_argument("--input", default="data/KCL_block_bare_2019-02-11_20-54-41___1083___1-03.pkl")
parser.add_argument("--second-input", default="data/3hoursRadonBalloon_2019-02-10_14-43-21___2321___2-56.pkl")
parser.add_argument("--output-dir", default=".", help="Directory for saved plots when a backend saves figures")
...
df = pd.read_pickle(args.second_input)
